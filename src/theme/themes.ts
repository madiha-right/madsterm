...
const paradigm: AppTheme = {
  ...
  diffAddedBg: "#0a1a0a",
  diffAddedText: "#4ae04a",
  diffAddedLineBg: "#0f2a0f",
  diffRemovedBg: "#1a0a0a",
  diffRemovedText: "#e04a4a",
  diffRemovedLineBg: "#2a0f0f",
  diffHunkHeader: "#111111",
  diffHunkHeaderText: "#888888",
  ...
  statusBarBg: "#000000",
  statusBarText: "#555555",
  statusBarAccent: "#ffffff",

  explorerBg: "#0a0a0a",
  explorerHover: "#111111",
  explorerSelected: "#1a1a1a",
  explorerIcon: "#555555",
  ...
  xtermTheme: {
    ...
    selectionInactiveBackground: "#33333355",
    black: "#000000",
    red: "#c65f5f",
    green: "#5fc65f",
    yellow: "#c6c65f",
